...
**
******************************************************************************
** FILENAME:    viewPixelFeatures.cpp
** AUTHOR(S):   Stephen Gould <stephen.gould@anu.edu.au>
** DESCRIPTION:
**  Application for visualizing pixel features.
**
*****************************************************************************/
...
#define WINDOW_NAME "viewPixelFeatures"
...
void usage()
{
    ...
    cerr << "USAGE: ./inferPixelFeatures [OPTIONS] (<imageList>|<baseName>)\n";
    cerr << "OPTIONS:\n"
...
int main(int argc, char *argv[])
{
    ...
    drwnSegImageStdPixelFeatures::FEATURE_GRID_SPACING = 0;
    ...
    for (int i = 0; i < (int)baseNames.size(); i++) {
        ...
        if (bVisualize || (outImageExt != NULL)) {
            canvas = drwnMultiSegVis::visualizePixelFeatures(instance);
            drwnResizeInPlace(canvas, cv::Size(640, 480));
        }
